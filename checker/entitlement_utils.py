def check_entitlements(entitlements: dict) -> dict:
    entitlements_mapping = {
        ...
        "com.apple.security.hardened-process": "Hardened Process",
        "com.apple.security.hardened-process.enhanced-security-version": "Enhanced Security Version",
        "com.apple.security.hardened-process.platform-restrictions": "Platform Restrictions",
        "com.apple.security.hardened-process.hardened-heap": "Hardened Heap",
        "com.apple.security.hardened-process.dyld-ro": "DYLD Read-Only",
        "com.apple.developer.icloud-extended-share-access": "iCloud Extended Share Access",
        "com.apple.developer.background-tasks.continued-processing.gpu": "Background Tasks GPU Processing",
        "com.apple.developer.financekit.transaction-picker": "FinanceKit Transaction Picker",
        "com.apple.developer.wifi-aware": "Wi-Fi Aware",
        "com.apple.developer.avfoundation.multitasking-camera-access": "AVFoundation Multitasking Camera Access",
        ...
        "com.apple.developer.dialing-app": "Dialing App",
        "com.apple.developer.messages.critical-messaging": "Critical Messaging",
        "com.apple.developer.calling-app": "Calling App",
        "com.apple.developer.messaging-app": "Messaging App",
        "com.apple.developer.device-discovery.pairing-access": "Device Discovery Pairing Access",
        "com.apple.developer.location.push": "Location Push",
        "com.apple.developer.devicecheck.app-attest-opt-in": "App Attest Opt-In",
        "com.apple.developer.navigation-app": "Navigation App",
        "com.apple.developer.carplay-audio": "CarPlay Audio",
        "com.apple.developer.identity-document-services.document-provider.mobile-document-types": "Identity Document Services",
        "com.apple.developer.declared-age-range": "Declared Age Range",
        "com.apple.developer.playable-content": "Playable Content",
        "com.apple.developer.carrier-messaging-app": "Carrier Messaging App",
        ...
        "com.apple.developer.translation-app": "Translation App",
